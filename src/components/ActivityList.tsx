...
type ActivityListProps = {
    activities: Activity[],
    dispatch: Dispatch<ActivityActions>//Con esto capturamos las acciones del useReducer 
}

export default function ActivityList({ activities, dispatch }: ActivityListProps) {
    //El parametro category que le pasamos desde la segunda funcion es el que le pasamos  por la funcion categoryName
